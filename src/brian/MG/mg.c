...
#pragma note noelle independent = 1 selected = 1 label = 10
  for (i3 = 1; i3 < n3-1; i3++) {
...
#pragma note noelle independent = 1 selected = 1 label = 11
...
//#pragma note noelle independent = 1 selected = 1
...
#pragma note noelle independent = 1 selected = 1 label = 9
  for (i3 = 0;i3 < n3; i3++) {
    for (i2 = 0; i2 < n2; i2++) {
      for (i1 = 0; i1 < n1; i1++) {
        z[i3][i2][i1] = 0.0;
